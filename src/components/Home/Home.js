...
const Home = () => {
  return (
    <div className="flex" id="home">
      <div className="flex-[0.6] flex flex-col py-[5rem]">
        <h1 className="text-[1.4rem] font-semibold pb-0">
          Hello, <span>I'm</span>
        </h1>
        <h1 className="text-[3.4rem] font-bold text-[#f30841] hover:scale-105 transition-all duration-300 hover:text-white hover:cursor-pointer">
          Amit Thakur
        </h1>
        ...
        <p className="text-[1rem] pt-5 text-gray-400">
          ...
          Technology in Computer Science and Engineering from Maharaja Surajmal
          Institute of Technology, New Delhi, India. Currently I'm doing an
          internship as FullStack Developer at Bessalani. I also do bit of
